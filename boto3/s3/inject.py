...
def inject_bucket_methods(class_attributes, **kwargs):
    ...
    utils.inject_attribute(class_attributes, 'head', bucket_head)
...
def bucket_head(self, Bucket, *args, **kwargs):
    """
    Calls s3.Client.head_bucket() to determine if a bucket exists and you have
    ...
    """
    self.meta.data = {}
    return self.meta.client.head_object(Bucket=Bucket)
